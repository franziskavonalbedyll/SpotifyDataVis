AUDIO_FEATURES_AND_GENRE_PATH = 'data/input_data/data_europe_top200_2017_2018_2019_2020_2021.csv'
PREPROCCESSED_DATA_PATH = 'data/preprocessed_data/preprocessed_data.csv'
CHARTS_PATH = 'data/input_data/charts.csv'
COVID_PATH = 'data/input_data/COVID-19_lockdowns_1.csv'
AUDIO_FEATURES_AVGS_PATH = 'data/preprocessed_data/audio_features_avg.csv'
PROCESSED_DATA_PATH = 'data/preprocessed_data/processed_data.csv'
